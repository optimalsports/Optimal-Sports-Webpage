...
export async function GET(request: NextRequest) {
  try {
    console.log('=== GETTING ONLY YOUR OPTIMALSPORTSLAUNCH PRODUCTS ===');
    ...
    if (!response.ok) {
      ...
      return NextResponse.json({
        error: 'Failed to fetch your store products',
    ...
    console.log(`Found ${products.length} products in your optimalsportslaunch store`);
    ...
    return NextResponse.json({
      success: true,
      message: 'Here are ONLY your optimalsportslaunch products:',
      storeId: storeId,
    ...
    console.error('Error getting your store products:', error);
    return NextResponse.json({
